    ...
    public class MailHandlerLogic : IMailHandler
    {
        ...
        public void SendEmail(Response res)
        {
            foreach (int i in Enum.GetValues(typeof(MailType)))
            {
                ...
                MailMessage message = GetMailAddresses(type, res.log.SchedulerTime);
        ...
        public MailMessage GetMailAddresses(MailType type, SchedulerTime time) 
        {
